    ...
    angular.module('debModule', []).provider('dbg', function () {
        ...
        var publicMethods = {
            ...
            info: function info() {
                ...
                //console.log('%c LOG ', logColors.blue,
                //    stk,'\n\t', output, '\n '
                //);
             ...
             */
            rs: function rs() {
                if (!debEnabled || !debugModules.rs || debugLevel < 3) return;
                ...
                labels ? console.log('%c%s %c log #routs and states ', logColors.time, time(), logColors.green, output, stkString) : console.log('%c%s %c log ', logColors.time, time(), logColors.green, '#routs and states > ' + output, stkString);
                //console.log('%c%s %c log #routs and states ', logColors.time , time(), logColors.green, output, '\t\t\t'+stk );
                // console.log('%c%s %c log #routs and states ', logColors.time , time(), logColors.blue2, output, '\t\t\t'+stk );
            },

            /* log for directives */
            dlog: function dlog() {
                if (!debEnabled || !debugModules.directives || debugLevel < 3) return;
                ...
                labels ? console.debug('%c%s %c log #directive ', logColors.time, time(), logColors.greenForDirectivesLog, output, stkString) : console.debug('%c%s %c log ', logColors.time, time(), logColors.greenForDirectivesLog, '#directive > ' + output, stkString);
...
//# sourceMappingURL=debModule.es5.js.map
