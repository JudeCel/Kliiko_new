(function () {
  ...
  SmsCreditService.$inject = ['$q', 'authResource', 'dbg'];

  function SmsCreditService($q, authResource, dbg) {
    var smsCreditServiceRestApi = authResource('/subscriptionSmsCredits/:path', null, {
