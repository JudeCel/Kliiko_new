...
module.exports = (Sequelize, DataTypes) => {
  var BrandProjectPreference = Sequelize.define('BrandProjectPreference', {
    ...
    colour_background:	{ type: DataTypes.STRING, allowNull: false,  defaultValue: "#ffffff"},
    ...
    colour_whiteboard_icon_background:	{ type: DataTypes.STRING, allowNull: false, defaultValue: "#408D2F"},
