  ...
  if(invite.accountId) {
    ...
    models.SessionMember.find({
      ...
      let inviteParams = {
        ...
        startTime: moment(session.startTimeFormat).format('h:mm:00'),
        endTime: moment(session.endTimeFormat).format('h:mm:00'),
        startDate: moment(session.startTimeFormat).format('YYYY-M-D'),
        endDate: moment(session.endTimeFormat).format('YYYY-M-D'),
