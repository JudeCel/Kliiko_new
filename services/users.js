...
function emailConfirmation(token, password, callback) {
...
module.exports = {
    ...
    getUserByTokenEmail: getUserByTokenEmail,
    setEmailConfirmationToken: setEmailConfirmationToken,
    checkConfirmationEmail: checkConfirmationEmail,
